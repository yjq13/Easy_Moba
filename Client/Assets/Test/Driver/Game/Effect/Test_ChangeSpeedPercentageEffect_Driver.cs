...
namespace Test
{
    ...
    class Test_ChangeSpeedPercentageEffect_Driver : Test_Effect_Driver
    {
        private float initSpeed = 0;

        public override void OnEffectTest()
        {
            EffectInfoData effect_info = new EffectInfoData(GameTargetType.OPPO_ONE, EFFECT_TYPE.ChangeSpeedPercentageEffect, "10", "");
            ...
            Assert.IsTrue(test_players[0].Role.CurrentSpeed - (initSpeed + initSpeed * 10 / 100) + 0.00001 < 0.0001 );
        }
