...
namespace Test
{
    ...
    class Test_SkipRoundEffect_Driver : Test_Effect_Driver
    {
        public override void OnEffectTest()
        {
            EffectInfoData effect_info = new EffectInfoData(GameTargetType.OPPO_ONE, EFFECT_TYPE.SkipRoundEffect, "2", "");
            ...
            Assert.IsTrue(test_players[0].Role.SkipRoundTimes == 2);
        }
