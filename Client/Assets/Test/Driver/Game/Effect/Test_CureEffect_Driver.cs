...
namespace Test
{
    ...
    class Test_CureEffect_Driver : Test_Effect_Driver
    {
        private int initHP = 0;

        public override void OnEffectTest()
        {
            EffectInfoData effect_info = new EffectInfoData(GameTargetType.OPPO_ONE, "Cure", "NONE", "2");
            ...
            Assert.IsTrue(test_players[0].Role.CurrentHP == (initHP + 2));
        }
        ...
        public override void InitPlayers()
        {
            ...
            test_player.Role.ChangeHP(-5);
            initHP          = test_player.Role.CurrentHP;
