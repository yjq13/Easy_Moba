...
namespace Test
{
    ...
    class Test_SkipCardOutEffect_Driver : Test_Effect_Driver
    {
        ...
        {
            EffectInfoData effect_info = new EffectInfoData(GameTargetType.OPPO_ONE, EFFECT_TYPE.SkipCardOutEffect, "2", "");
            ...
            Assert.IsTrue(test_players[0].Role.SkipCardOutTimes == 2);
        }
