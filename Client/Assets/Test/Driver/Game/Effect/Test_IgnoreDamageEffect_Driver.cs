...
namespace Test
{
    ...
    class Test_IgnoreDamageEffect_Driver : Test_Effect_Driver
    {
        public override void OnEffectTest()
        {
            EffectInfoData effect_info = new EffectInfoData(GameTargetType.OPPO_ONE, EFFECT_TYPE.IgnoreDamageEffect, "2", "");
