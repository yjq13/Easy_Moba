...
namespace Test
{
    ...
    class Test_DrawCardEffect_Driver : Test_Effect_Driver
    {
        public override void OnEffectTest()
        {
            EffectInfoData effect_info = new EffectInfoData(GameTargetType.OPPO_ONE, EFFECT_TYPE.DrawCardEffect, "2", "");
            ...
            Assert.IsTrue(test_players[0].Role.CurrentCanUseCardList.Count == 2);
        }
