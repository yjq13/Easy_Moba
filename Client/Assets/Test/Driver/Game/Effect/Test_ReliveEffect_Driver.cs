...
namespace Test
{
    ...
    class Test_ReliveEffect_Driver : Test_Effect_Driver
    {
        public override void OnEffectTest()
        {
            EffectInfoData effect_info = new EffectInfoData(GameTargetType.OPPO_ONE, EFFECT_TYPE.ReliveEffect, "2", "");
            ...
            Assert.IsTrue(test_players[0].Role.CurrentHP == 2);
        }
