...
-record(reply_sdk_login,
        {token = []             :: iolist() | undefined, % = 1
         svr_id = 0             :: non_neg_integer() | undefined, % = 2, 32 bits
         host = []              :: iolist() | undefined, % = 3
         open_id = []           :: iolist() | undefined, % = 4
         union_id = []          :: iolist() | undefined % = 5
        }).
-endif.
...
-record(reply_login,
        {user = undefined       :: down_pb:reply_user() | undefined, % = 1
         ...
         region = default       :: 'default' | integer() | undefined % = 3, enum t_region
        }).
-endif.
